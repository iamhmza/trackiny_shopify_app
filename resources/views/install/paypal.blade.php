...
<main class="auth">
    <section class="doorway">
        ...
        <div class="absolute inset-0 md:-ml-8 z-0">
            <svg class="fill-current w-full h-full" viewbox="0 0 1149.342 1042" xmlns="http://www.w3.org/2000/svg"
                ...
                <defs>
                    <lineargradient gradientunits="objectBoundingBox" id="linear-gradient" x1="0.281" x2="0.962"
                        y1="0.283" y2="0.931">
                ...
                <g data-name="Layer 2" id="Layer_2" transform="translate(0 55.092)">
                    <g data-name="Layer 1" id="Layer_1" transform="translate(0 -55.092)">
                        <path
                            ...
                            data-name="Path 12" fill="url(#linear-gradient)" id="Path_12">
                        </path>
                    </g>
                </g>
            </svg>
    ...
    <section class="door">
        ...
        <form action="{{url('/paypal/login')}}" method="get">
            {{csrf_field()}}
            <input class="block border border-gray-400 w-64 rounded text-sm p-3 mx-auto md:mx-0 mt-4"
                name="paypalClientId" placeholder="API key" type="text" />
            <input class="block border border-gray-400 w-64 rounded text-sm p-3 mx-auto md:mx-0 mt-4"
                name="paypalSecret" placeholder="API secret" type="text" />
