...
<main class="auth">
    ...
    <section class="door">
        ...
        <div class="w-48 mx-auto md:w-56 md:mx-0 mt-8">
            <img alt="shopify logo" src="{{asset('images/wc_logo.png')}}"/>
        </div>
        ...
        <form class="mt-4" action="{{url('/wc/login')}}" method="post">
            {{csrf_field()}}
            <input class="block border border-gray-400 w-64 rounded text-sm p-3 mx-auto md:mx-0" placeholder="Consumer key" type="text"/>
            <input class="block border border-gray-400 w-64 rounded text-sm p-3 mx-auto md:mx-0 mt-4" placeholder="Consumer secret" type="text"/>
